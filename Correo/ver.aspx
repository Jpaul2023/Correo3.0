<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ver.aspx.cs" Inherits="Correo.ver" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active"> Lake </h2>

    <!-- Icon -->
    <div class="fadeIn first">
      <img src="logo.jpg" id="icon" alt="User Icon" class="auto-style5" />
    </div>
